...
* **Recurrent exports (BiLSTM, padding, EnumeratedShapes):** [PyTorch LSTM → Core ML on Apple Silicon](Guides/apple-silicon/CoreML-LSTM-export-guide.md); [enumerated shapes vs ANE scheduling](Guides/apple-silicon/CoreML-LSTM-Enumerated-Shapes.md).
