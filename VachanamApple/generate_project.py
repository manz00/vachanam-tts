...
def create_project():
    ...
    vachanam_files = []
    for folder in ["Shared", "iOS", "macOS"]:
    ...
    pbx.append('\t\t\trelativePath = "Packages/kokoro-coreml/swift-tts";')
    pbx.append("\t\t};")
    ...
    pbx.append(f"\t\t{plist_uuid} /* Info.plist */ = {{isa = PBXFileReference; lastKnownFileType = text.plist.xml; path = \"Info.plist\"; sourceTree = \"<group>\"; }};")
    pbx.append(f"\t\t{entitlements_uuid} /* Vachanam.entitlements */ = {{isa = PBXFileReference; lastKnownFileType = text.plist.entitlements; path = \"Vachanam.entitlements\"; sourceTree = \"<group>\"; }};")
    pbx.append(f"\t\t{registry_uuid} /* model_registry.json */ = {{isa = PBXFileReference; lastKnownFileType = text.json; path = \"Resources/model_registry.json\"; sourceTree = \"<group>\"; }};")
    pbx.append(f"\t\t{font_reg_uuid} /* OpenDyslexic-Regular.otf */ = {{isa = PBXFileReference; lastKnownFileType = file; path = \"Resources/OpenDyslexic-Regular.otf\"; sourceTree = \"<group>\"; }};")
    pbx.append(f"\t\t{font_bold_uuid} /* OpenDyslexic-Bold.otf */ = {{isa = PBXFileReference; lastKnownFileType = file; path = \"Resources/OpenDyslexic-Bold.otf\"; sourceTree = \"<group>\"; }};")
    pbx.append(f"\t\t{assets_uuid} /* Assets.xcassets */ = {{isa = PBXFileReference; lastKnownFileType = folder.assetcatalog; path = \"Resources/Assets.xcassets\"; sourceTree = \"<group>\"; }};")
    pbx.append(f"\t\t{kokoro_models_uuid} /* KokoroModels */ = {{isa = PBXFileReference; lastKnownFileType = folder; path = \"Resources/KokoroModels\"; sourceTree = \"<group>\"; }};")
    pbx.append(f"\t\t{soundscapes_uuid} /* Soundscapes */ = {{isa = PBXFileReference; lastKnownFileType = folder; path = \"Resources/Soundscapes\"; sourceTree = \"<group>\"; }};")
    pbx.append(f"\t\t{math_maps_uuid} /* MathMaps */ = {{isa = PBXFileReference; lastKnownFileType = folder; path = \"Resources/MathMaps\"; sourceTree = \"<group>\"; }};")
    pbx.append(f"\t\t{benchmark_uuid} /* Benchmark */ = {{isa = PBXFileReference; lastKnownFileType = folder; path = \"Resources/Benchmark\"; sourceTree = \"<group>\"; }};")
    ...
    pbx.append("\t\t\tisa = PBXGroup;")
    pbx.append("\t\t\tchildren = (")
    pbx.append(f"\t\t\t\t{shared_group_uuid} /* Shared */,")
    pbx.append(f"\t\t\t\t{ios_group_uuid} /* iOS */,")
    pbx.append(f"\t\t\t\t{macos_group_uuid} /* macOS */,")
    pbx.append(f"\t\t\t\t{tests_group_uuid} /* Tests */,")
    pbx.append(f"\t\t\t\t{uitests_group_uuid} /* UITests */,")
    pbx.append(f"\t\t\t\t{resources_group_uuid} /* Resources */,")
    ...
    # Shared Group
    shared_files = [f for f in vachanam_files if f[1].startswith("Shared/")]
    pbx.append(f"\t\t{shared_group_uuid} /* Shared */ = {{")
    pbx.append("\t\t\tisa = PBXGroup;")
    pbx.append("\t\t\tchildren = (")
    for _, fpath in shared_files:
        f_uuid, fname = file_refs[fpath]
        pbx.append(f"\t\t\t\t{f_uuid} /* {fname} */,")
    pbx.append("\t\t\t);")
    pbx.append("\t\t\tname = \"Shared\";")
    pbx.append("\t\t\tsourceTree = \"<group>\";")
    pbx.append("\t\t};")
    
    # iOS Group (iPadOS & PencilKit)
    ios_files = [f for f in vachanam_files if f[1].startswith("iOS/")]
    pbx.append(f"\t\t{ios_group_uuid} /* iOS */ = {{")
    pbx.append("\t\t\tisa = PBXGroup;")
    pbx.append("\t\t\tchildren = (")
    for _, fpath in ios_files:
        f_uuid, fname = file_refs[fpath]
        pbx.append(f"\t\t\t\t{f_uuid} /* {fname} */,")
    pbx.append("\t\t\t);")
    pbx.append("\t\t\tname = \"iOS (iPadOS & PencilKit)\";")
    pbx.append("\t\t\tsourceTree = \"<group>\";")
    pbx.append("\t\t};")
    
    # macOS Group (Mac Catalyst & Audiobook Studio)
    macos_files = [f for f in vachanam_files if f[1].startswith("macOS/")]
    pbx.append(f"\t\t{macos_group_uuid} /* macOS */ = {{")
    pbx.append("\t\t\tisa = PBXGroup;")
    pbx.append("\t\t\tchildren = (")
    for _, fpath in macos_files:
        f_uuid, fname = file_refs[fpath]
        pbx.append(f"\t\t\t\t{f_uuid} /* {fname} */,")
    pbx.append("\t\t\t);")
    pbx.append("\t\t\tname = \"macOS (Mac Catalyst & Studio)\";")
    pbx.append("\t\t\tsourceTree = \"<group>\";")
    pbx.append("\t\t};")
    ...
    pbx.append("\t\t\t\tASSETCATALOG_COMPILER_GENERATE_ASSET_SYMBOLS = YES;")
    pbx.append("\t\t\t\tASSETCATALOG_COMPILER_GENERATE_SWIFT_ASSET_SYMBOL_EXTENSIONS = YES;")
    pbx.append("\t\t\t\tCODE_SIGN_ENTITLEMENTS = Vachanam.entitlements;")
