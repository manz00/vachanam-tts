...
public struct KokoroComputePolicy: Equatable, Sendable {
    ...
    /// Context-aware default policy: CPU-only on iOS Simulator to avoid missing MPSGraph/ANE exceptions,
    /// and staged GPU/NeuralEngine on physical hardware.
    public static var defaultPolicy: KokoroComputePolicy {
